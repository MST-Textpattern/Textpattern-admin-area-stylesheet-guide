...
# The attributes @cellpadding@, @cellspacing@, @border@ and @width@ are unnecessary and can (and should) be styled with CSS instead.
# A @scope@ attrbite should be applied to cells where appropriate (accessibility).
